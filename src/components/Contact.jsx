    ...
    return (
        <section className="contact section" id="contact">
            ...
            <div className="contact__container container grid">
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">r.ivann.gonzalezz@gmail.com</span>

                            <a href="" className="contact__button"> Escribame {" "}<i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
                        </div>
                        ...
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">+54-11-4097-0295</span>
                ...
                <div className="contact__content">
                    <h3 className="contact__title">Escribeme tu propuesta</h3>
